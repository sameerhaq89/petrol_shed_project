                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('tanks.update', $tank->id) }}" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select class="form-control form-select @error('fuel_type_id') is-invalid @enderror" id="fuel_type_id" name="fuel_type_id" required>
                                <option value="">-- Select Fuel Type --</option>
                                {{-- We need to fetch all fuel types. If not passed from controller, use relations or injected service data --}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" value="{{ number_format($tank->current_stock, 2) }}" disabled>
