...
<div class="content-wrapper">
    ...
    <div class="page-header">
        <h3 class="page-title"> Tank Details </h3>
                ...
                <div class="card-body">
                    ...
                    <div class="progress progress-md mt-3">
                        @php
                            ...
                            $color = $percentage < 20 ? 'bg-danger' : 'bg-success';
                        @endphp
    ...
    <div class="mt-3">
        <a href="{{ route('tanks.index') }}" class="btn btn-light">Back to List</a>
        <a href="{{ route('tanks.edit', $tank->id) }}" class="btn btn-primary">Edit Tank</a>
    </div>
