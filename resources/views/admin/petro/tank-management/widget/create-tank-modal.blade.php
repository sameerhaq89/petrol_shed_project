                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <label for="capacity" class="form-label">Capacity (L) <span
                                    class="text-danger">*</span></label>
                            <input type="number" step="0.01" class="form-control" name="capacity" placeholder="20000"
                                required>
                        </div>
                        <div class="col-md-3 mb-3">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <input type="number" step="0.01" class="form-control" name="maximum_level"
                                placeholder="19500">
                        </div>
                        <div class="col-md-3 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="text" class="form-control" name="manufacturer" placeholder="Tank Maker Inc.">
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="material" class="form-label">Material</label>
                            <input type="text" class="form-control" name="material" placeholder="Steel / Fiberglass">
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" class="form-control" name="last_cleaned_date">
                        </div>
                    </div>
