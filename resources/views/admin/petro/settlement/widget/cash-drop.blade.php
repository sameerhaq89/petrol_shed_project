            ...
            <div class="card-body">
                ...
                <form action="{{ route('cash-drop.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="pumper_id" class="form-control" required>
    ...
    @endforeach
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" step="0.01" name="amount" class="form-control form-control-lg font-weight-bold text-success" placeholder="0.00" required>
                        </div>
                    </div>
                    ...
                    <div class="form-group mb-4">
                        ...
                        <textarea name="notes" class="form-control" rows="2" placeholder="e.g. 5000 x 4 notes"></textarea>
                    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- <form action="{{ route('cash-drops.destroy', $drop->id) }}" ... --}}
                                    <button class="btn btn-inverse-danger btn-sm btn-icon" disabled title="Delete feature pending">
