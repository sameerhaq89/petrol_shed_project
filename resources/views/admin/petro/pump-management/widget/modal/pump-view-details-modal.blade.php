...
<div class="modal fade" id="pumpViewDetailsModal" tabindex="-1" aria-labelledby="pumpViewDetailsModal" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" style="max-width: 780px;">
        <div class="modal-content">
            <div class="modal-header bg-gradient-success text-white">
                <h5 class="modal-title d-flex align-items-center" id="pumpViewDetailsModal">
            ...
            <div class="modal-body">
                <div class="row g-3">
                    <div class="col-12 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body py-3">
                                <h6 class="text-primary mb-3"><i class="mdi mdi-calendar-range"></i> Date Information
                                </h6>
                                <div class="row mb-2">
                    ...
                    <div class="col-12 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body py-3">
                                <h6 class="text-warning mb-3"><i class="mdi mdi-pump"></i> Pump Details</h6>
                                <div class="row mb-2">
                                    <div class="col-5"><span class="text-muted small">Pump No:</span></div>
                                    <div class="col-7"><span class="fs-sm1" id="modalPrice"></span></div>
                                </div>
                                <div class="row mb-2">
                                    <div class="col-5"><span class="text-muted small">Pump Name:</span></div>
                    ...
                    <div class="col-12 col-md-6 d-flex">
                        <div class="card flex-fill">
                            <div class="card-body py-3">
                                ...
                                <div class="row mb-2">
                                    <div class="col-5"><span class="text-muted small">Tank </span></div>
                                    <div class="col-7"><span class="fs-sm1" id="modalClose"></span></div>
                                </div>
                            </div>
                        </div>
