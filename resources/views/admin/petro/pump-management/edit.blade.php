            ...
            <form action="{{ route('pumps.update', $pump->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" name="pump_name" class="form-control" value="{{ $pump->pump_name }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label>Pump Number</label>
                        <input type="text" name="pump_number" class="form-control" value="{{ $pump->pump_number }}" required>
                    </div>
                    <div class="col-md-6 mb-3">
                ...
                <a href="{{ route('pumps.index') }}" class="btn btn-light">Cancel</a>
            </form>
        </div>
    </div>
</div>
