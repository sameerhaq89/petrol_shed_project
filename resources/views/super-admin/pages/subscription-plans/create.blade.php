...
@section('title', 'Create Subscription Plan - SuperAdmin Panel')
...
@section('content')
    <div class="dashboard-container">
        ...
        <div class="form-container">
            <form action="{{ route('super-admin.plans.store') }}" method="POST" class="modern-form">
                @csrf
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <select id="max_addons" name="max_addons" class="form-control" required>
                            <option value="0" {{ old('max_addons') == 0 ? 'selected' : '' }}>None (Trial)</option>
                            <option value="1" {{ old('max_addons') == 1 ? 'selected' : '' }}>1 Addon (Basic)</option>
                            <option value="3" {{ old('max_addons') == 3 ? 'selected' : '' }}>3 Addons (Standard)</option>
                            <option value="-1" {{ old('max_addons') == -1 ? 'selected' : '' }}>Unlimited (Premium)</option>
                        </select>
                        @error('max_addons')
                            <span class="error-message">{{ $message }}</span>
                        @enderror
