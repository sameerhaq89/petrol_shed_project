...
@section('content')
    ...
    <div class="content-wrapper" style="padding: 1.1rem 2.25rem !important;">
        ...
        {{-- <div class="page-header"> --}}
            ...
            {{-- <div class="btn-group">
                <button class="btn btn-gradient-success btn-block me-2" data-bs-toggle="modal" data-bs-target="#dropCashModal">
                    <i class="mdi mdi-cash-multiple"></i> DROP CASH
                </button>
                ...
                <form action="#" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="number" name="current-meter" class="form-control" placeholder="Enter meter" required
                                min="1" step="100,550">
                        </div>
                        <div class="form-group">
